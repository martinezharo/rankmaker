...
export const zh: LocaleDict = {
	tooltip: {
		...
		shareTemplate: '复制链接，让别人也来排同一个模板',
		downloadImage: '把排名保存为图片，随时可以发布',
		shareOnX: '把这个模板发到 X',
		reorder: '拖动行，修正任何对决没排对的位置',
		voteUp: '点赞——告诉大家这个模板值得一排',
		voteDown: '点踩——这个模板还有提升空间',
		save: '收藏到你的列表，之后好找',
		unsave: '把这个模板移出收藏列表',
		share: '分享这个模板',
		category: '{category}模板',
		timesRanked: '有多少人用这个模板完成了排名',
		votes: '排过的人给出的点赞数减去点踩数',
		viewProfile: '前往 @{username} 的主页',
		verified: '已认证账号',
		visibilityPrivate: '只有你能打开这个模板',
		visibilityUnlisted: '不出现在搜索里——拿到链接的人都能打开',
		coverReplace: '换一张封面图',
		coverRemove: '移除封面——改用你的选项图片拼贴',
		optionImage: '为这个选项添加图片',
		optionImageReplace: '给这个选项换一张图片',
		optionImageRemove: '移除图片，保留该选项',
		optionRemove: '从模板中删除这个选项',
		addOption: '再添加一个待排名的选项',
		editTemplate: '编辑这个模板——分享链接保持不变',
		deleteTemplate: '永久删除这个模板',
		deleteLocalTemplate: '从这个浏览器中删除该模板',
		commentUpvote: '给这条评论点赞',
		commentDownvote: '给这条评论点踩',
		menu: '菜单',
		notifications: '通知',
		social: '在 {network} 上关注 RANKMAKER',
	},
	select: {
	...
	home: {
		title: 'RANKMAKER — 一对一对决，为万物排名',
		metaDescription:
			'通过快速的一对一对决构建可信的排名。为电影、游戏、音乐等排名——创建自己的模板，或游玩社区制作的数百个模板。免费，无需注册。',
		heroEyebrow: '一对一对决排名工具',
		heroHeadline1: '万物皆可排名。',
		heroHeadline2: '一场对决，见分晓。',
		heroSubtitle:
			'告别混乱的等级表。RANKMAKER 把任何清单变成快速的一对一对决——你选出胜者，我们为你构建最终排名。电影、游戏、美食、音乐：只要能列出来，就能排名。',
		createTemplate: '创建模板',
		exploreTemplates: '探索模板',
		demoTitle: '电影系列',
		demoStarWars: '星球大战',
		demoMarvel: '漫威',
		demoHarryPotter: '哈利·波特',
		demoLotr: '指环王',
		followingHeading: '关注',
		emptyTitle: '暂无模板',
	...
	history: {
		...
		loadMore: '显示更多',
		loading: '正在加载排名…',
		loadError: '无法加载此排名。请关闭卡片后重试。',
		emptyBody: '您还没有为任何内容排名。',
		findSomething: '找些内容来排名',
	},
	saved: {
		title: '已保存的模板 — RANKMAKER',
		heading: '已保存的模板',
		subtitle: '你保存以便稍后查看的模板。',
		empty: '你还没有保存任何模板。',
		emptyCta: '查找要保存的模板',
	},
	profile: {
	...
	form: {
		...
		coverCollageNote: '尚无封面 — 将使用由选项图片组成的拼贴图。',
		uploadCta: '点击或拖入图片即可上传',
		uploadHint: 'JPG、PNG、WebP、AVIF 或 GIF · 最大 10 MB',
		uploading: '上传中…',
		replaceImage: '更换图片',
		removeImage: '移除图片',
		optionAddImage: '添加图片',
		...
		errCategory: '请选择分类。',
		errCoverRequired: '请上传封面图片，或为至少 4 个选项添加图片。',
...
<section><h2 class="text-xl font-semibold text-text-primary mb-3 mt-6">12. 联系方式</h2><p>如有疑问，请联系：<a href="mailto:rankmaker.net@gmail.com" class="text-primary hover:underline">rankmaker.net@gmail.com</a>。</p></section>`,
	...
	preferences: {
		title: '偏好设置 — RANKMAKER',
		metaDescription: '选择你的语言，并决定 RANKMAKER 是否向你显示标记为成人内容的模板。',
		heading: '偏好设置',
		subtitle: 'RANKMAKER 对你的呈现方式。',
		savedInBrowser: '保存在此浏览器中。',
		savedOnAccount: '保存在你的账户中，适用于所有设备。',
		signInHint: '登录后可在所有设备上保留这些偏好设置。',
		languageHeading: '语言',
		languageDesc: '界面语言。模板内容尚未翻译。',
		contentHeading: '内容',
		matureLabel: '显示成人内容',
		matureDesc:
	...
	mature: {
		...
		gateEnable: '显示成人内容',
		gateHome: '返回首页',
		gateSettingsHint: '你可以随时在偏好设置中更改。',
		gateError: '无法更新你的偏好设置。请重试。',
		formLabel: '成人内容',
		formHint:
	...
	notifications: {
		title: '通知 — RANKMAKER',
		heading: '通知',
		subtitle: '您模板上的评论、对您的回复，以及您关注的人发布的新模板。',
		loginRequired: '登录即可查看您的通知。',
		login: '登录',
		empty: '您已是最新状态 — 暂时没有任何内容。',
		filterAll: '全部',
		filterComments: '我的模板',
		filterReplies: '回复',
		filterTemplates: '新模板',
		...
		yesterday: '昨天',
		newBadge: '新',
		msgCommentOnTemplate: '{actor} 评论了您的模板”{title}”',
		msgCommentReply: '{actor} 回复了您在”{title}”中的评论',
		msgNewTemplate: '{actor} 发布了新模板：”{title}”',
		emailPrefLink: '在偏好设置中管理通知邮件',
	},
	email: {
		cta: '在 RANKMAKER 上查看',
		footer: '您收到此邮件是因为您的账户已开启通知邮件。在 {url} 管理它们',
		commentOnTemplate: {
			subject: '您的模板有新评论',
			heading: '”{title}”有新评论',
			intro: '{actor} 评论了您的模板”{title}”。',
		},
		commentReply: {
			subject: '{actor} 回复了您的评论',
			heading: '您有新回复',
			intro: '{actor} 回复了您在”{title}”中的评论。',
		},
	},
};
