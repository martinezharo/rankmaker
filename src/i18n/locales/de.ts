...
export const de: LocaleDict = {
	tooltip: {
		...
		voteUp: 'Hochstufen — zeig anderen, dass die Vorlage sich lohnt',
		voteDown: 'Herunterstufen — diese Vorlage hat noch Luft nach oben',
		save: 'In deiner Liste sichern, um sie später wiederzufinden',
		unsave: 'Diese Vorlage aus deiner Liste entfernen',
		share: 'Diese Vorlage teilen',
		...
		addOption: 'Eine weitere Option zum Ranken hinzufügen',
