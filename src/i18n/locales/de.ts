...
export const de: LocaleDict = {
	tooltip: {
		undo: 'Letzte Wahl zurücknehmen und das Duell erneut spielen',
		...
		downloadImage: 'Ranking als Bild speichern — fertig zum Posten',
		shareOnX: 'Diese Vorlage auf X posten',
		reorder: 'Zeilen ziehen, um eine unpassende Position zu korrigieren',
		save: 'In deiner Liste sichern, um sie später wiederzufinden',
		unsave: 'Diese Vorlage aus deiner Liste entfernen',
		shareTemplate: 'Link kopieren, damit andere dieselbe Vorlage ranken',
		category: '{category}-Vorlage',
		timesRanked: 'Wie viele Rankings andere aus dieser Vorlage fertiggestellt haben',
		votes: 'Hoch- minus Herunterstufungen von allen, die sie gerankt haben',
		viewProfile: 'Zum Profil von @{username}',
		verified: 'Verifiziertes Konto',
		visibilityPrivate: 'Nur du kannst diese Vorlage öffnen',
		visibilityUnlisted: 'Nicht in der Suche — wer den Link hat, kann sie öffnen',
		coverReplace: 'Dieses Titelbild gegen ein anderes tauschen',
		coverRemove: 'Titelbild entfernen — eine Collage deiner Optionen springt ein',
		optionImage: 'Bild für diese Option hinzufügen',
		optionImageReplace: 'Bild dieser Option gegen ein anderes tauschen',
		optionImageRemove: 'Bild entfernen, Option behalten',
		optionRemove: 'Diese Option aus der Vorlage löschen',
		editTemplate: 'Vorlage bearbeiten — der Teilen-Link bleibt gleich',
		deleteTemplate: 'Diese Vorlage dauerhaft löschen',
		deleteLocalTemplate: 'Diese Vorlage aus diesem Browser löschen',
		commentUpvote: 'Diesen Kommentar hochstufen',
		commentDownvote: 'Diesen Kommentar herunterstufen',
		menu: 'Menü',
		notifications: 'Benachrichtigungen',
		social: 'RANKMAKER auf {network}',
	},
	select: {
	...
	seoContent: {
		...
		brandCoverAlt: 'Ein 1-gegen-1-Duell zwischen zwei Optionen und die Top 3, die daraus entsteht',
	...
	form: {
		...
		coverCollageNote: 'Kein Titelbild — diese Collage aus deinen Optionsbildern wird verwendet.',
		...
		errCoverRequired: 'Füge ein Titelbild hinzu oder gib mindestens 4 Optionen ein Bild.',
...
<section class="mb-6"><h2 class="text-xl font-semibold text-text-primary mb-3 mt-6">6. Kontakt</h2><p>Bei Fragen oder Klarstellungen zu diesem Impressum kontaktiere uns bitte unter: <a href="mailto:rankmaker.net@gmail.com" class="text-primary hover:underline">rankmaker.net@gmail.com</a>.</p></section>`,
		...
		cookiePolicy: {
			...
			body: legalContent.de.cookiePolicy,
		},
		privacyPolicy: {
			...
			body: legalContent.de.privacyPolicy,
		},
		termsOfUse: {
...
<section><h2 class="text-xl font-semibold text-text-primary mb-3 mt-6">6. Cookies und Browser-Speicher</h2><p>Wir verwenden nur die notwendigen Cookies und den Browser-Speicher, die in unserer Cookie-Richtlinie beschrieben sind. Wir verwenden keine Werbe- oder Analyse-Cookies von Drittanbietern.</p></section>
