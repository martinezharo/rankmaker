...
<section><h2 class="text-xl font-semibold text-text-primary mb-3 mt-6">12. Hubungi</h2><p>Untuk soalan, hubungi: <a href="mailto:rankmaker.net@gmail.com" class="text-primary hover:underline">rankmaker.net@gmail.com</a>.</p></section>`,
	...
	notifications: {
		...
		subtitle: 'Ulasan pada templat anda, balasan kepada anda, dan templat baharu daripada orang yang anda ikuti.',
		loginRequired: 'Log masuk untuk melihat pemberitahuan anda.',
		login: 'Log masuk',
		empty: 'Anda sudah terkini — tiada apa-apa di sini lagi.',
		filterAll: 'Semua',
		filterComments: 'Pada templat saya',
		filterReplies: 'Balasan',
		filterTemplates: 'Templat baharu',
		today: 'Hari ini',
		yesterday: 'Semalam',
		newBadge: 'Baharu',
	...
	email: {
		...
		footer: 'Anda menerima ini kerana pemberitahuan e-mel dihidupkan untuk akaun anda. Uruskan di {url}',
		commentOnTemplate: {
			subject: 'Ulasan baharu pada templat anda',
			heading: 'Ulasan baharu pada “{title}”',
			intro: '{actor} mengulas templat anda “{title}”.',
		},
		commentReply: {
			subject: '{actor} membalas ulasan anda',
			heading: 'Anda mempunyai balasan baharu',
			intro: '{actor} membalas ulasan anda pada “{title}”.',
		},
	},
};
