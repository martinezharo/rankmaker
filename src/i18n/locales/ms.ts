...
export const ms: LocaleDict = {
	tooltip: {
		...
		voteUp: 'Undi naik — beritahu orang lain templat ini berbaloi',
		voteDown: 'Undi turun — templat ini boleh diperbaiki',
		save: 'Simpan dalam senarai anda supaya mudah dicari nanti',
		unsave: 'Buang templat ini daripada senarai simpanan anda',
		share: 'Kongsi templat ini',
		...
		addOption: 'Tambah satu lagi pilihan untuk diranking',
