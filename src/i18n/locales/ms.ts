...
export const ms: LocaleDict = {
	tooltip: {
		undo: 'Batalkan pilihan terakhir anda dan ulang perlawanan itu',
		...
		downloadImage: 'Simpan ranking anda sebagai imej, sedia untuk dikongsi',
		shareOnX: 'Kongsi templat ini di X',
		reorder: 'Seret baris untuk membetulkan kedudukan yang tak kena',
		save: 'Simpan dalam senarai anda supaya mudah dicari nanti',
		unsave: 'Buang templat ini daripada senarai simpanan anda',
		shareTemplate: 'Salin pautan supaya orang lain boleh ranking templat yang sama',
		category: 'Templat {category}',
		timesRanked: 'Berapa banyak ranking yang telah disiapkan daripada templat ini',
		votes: 'Undi naik tolak undi turun daripada mereka yang telah meranking',
		viewProfile: 'Pergi ke profil @{username}',
		verified: 'Akaun disahkan',
		visibilityPrivate: 'Hanya anda boleh membuka templat ini',
		visibilityUnlisted: 'Tersembunyi daripada carian — sesiapa dengan pautan boleh membukanya',
		coverReplace: 'Tukar kulit ini dengan imej lain',
		coverRemove: 'Buang kulit — kolaj imej pilihan anda akan menggantikannya',
		optionImage: 'Tambah imej untuk pilihan ini',
		optionImageReplace: 'Tukar imej pilihan ini dengan yang lain',
		optionImageRemove: 'Buang imej, kekalkan pilihan',
		optionRemove: 'Padam pilihan ini daripada templat',
		editTemplate: 'Edit templat ini — pautan kongsi kekal sama',
		deleteTemplate: 'Padam templat ini secara kekal',
		deleteLocalTemplate: 'Padam templat ini daripada pelayar ini',
		commentUpvote: 'Undi naik komen ini',
		commentDownvote: 'Undi turun komen ini',
		menu: 'Menu',
		notifications: 'Pemberitahuan',
		social: 'RANKMAKER di {network}',
	},
	select: {
	...
	form: {
		...
		coverCollageNote: 'Tiada penutup — kolaj imej pilihan anda ini akan digunakan.',
		...
		optionAddImage: 'Tambah imej',
		options: 'Pilihan',
		optionsMin: 'min {n}',
		optionsHelp:
			'Benda-benda yang orang akan ranking dalam pertarungan 1v1. Imej adalah pilihan — klik petak di sebelah nama untuk memuat naik satu.',
		...
		errCoverRequired: 'Tambah imej penutup, atau imej pada sekurang-kurangnya 4 pilihan.',
...
<section class="mb-6"><h2 class="text-xl font-semibold text-text-primary mb-3 mt-6">6. Hubungi</h2><p>Untuk sebarang soalan atau penjelasan mengenai Notis Undang-undang ini, sila hubungi kami di: <a href="mailto:rankmaker.net@gmail.com" class="text-primary hover:underline">rankmaker.net@gmail.com</a>.</p></section>`,
		...
		cookiePolicy: {
			...
			heading: 'Dasar Kuki',
			body: legalContent.ms.cookiePolicy,
		},
		privacyPolicy: {
			...
			body: legalContent.ms.privacyPolicy,
		},
		termsOfUse: {
...
<section><h2 class="text-xl font-semibold text-text-primary mb-3 mt-6">6. Kuki dan storan pelayar</h2><p>Kami hanya menggunakan kuki yang diperlukan dan storan pelayar seperti yang diterangkan dalam Dasar Kuki. Kami tidak menggunakan kuki pengiklanan atau analitik pihak ketiga.</p></section>
