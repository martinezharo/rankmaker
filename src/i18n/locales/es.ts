...
export const es: LocaleDict = {
	tooltip: {
		undo: 'Deshaz tu última elección y repite ese enfrentamiento',
		...
		downloadImage: 'Guarda tu ranking como imagen, lista para publicar',
		shareOnX: 'Publica esta plantilla en X',
		reorder: 'Arrastra las filas para corregir cualquier posición que no encaje',
		save: 'Guárdala en tu lista para encontrarla más tarde',
		unsave: 'Quita esta plantilla de tu lista de guardados',
		shareTemplate: 'Copia un enlace para que otros ordenen la misma plantilla',
		category: 'Plantilla de {category}',
		timesRanked: 'Cuántos rankings ha completado la gente con esta plantilla',
		votes: 'Votos a favor menos votos en contra de quienes la han ordenado',
		viewProfile: 'Ir al perfil de @{username}',
		verified: 'Cuenta verificada',
		visibilityPrivate: 'Solo tú puedes abrir esta plantilla',
		visibilityUnlisted: 'Oculta en las búsquedas: cualquiera con el enlace puede abrirla',
		coverReplace: 'Cambia esta portada por otra imagen',
		coverRemove: 'Quita la portada: en su lugar se usa un collage de tus opciones',
		optionImage: 'Añade una imagen para esta opción',
		optionImageReplace: 'Cambia la imagen de esta opción por otra',
		optionImageRemove: 'Quita la imagen y conserva la opción',
		optionRemove: 'Elimina esta opción de la plantilla',
		editTemplate: 'Edita esta plantilla: el enlace para compartir no cambia',
		deleteTemplate: 'Elimina esta plantilla para siempre',
		deleteLocalTemplate: 'Elimina esta plantilla de este navegador',
		commentUpvote: 'Vota a favor de este comentario',
		commentDownvote: 'Vota en contra de este comentario',
		menu: 'Menú',
		notifications: 'Notificaciones',
		social: 'RANKMAKER en {network}',
	},
	select: {
	...
	seoContent: {
		...
		brandCoverAlt: 'Un duelo 1v1 entre dos opciones y el top 3 que produce',
	...
	signup: {
		...
		marketingLabel: 'Quiero enterarme de las novedades de RANKMAKER',
		marketingDesc:
			'Nuevas funciones y los mejores rankings, de vez en cuando. Es opcional, sin spam, y puedes desactivarlo cuando quieras en tus preferencias.',
		marketingPolicy: 'Cómo tratamos tus datos',
	...
	form: {
		...
		visibilityUnlockCta: 'Inicia sesión para desbloquear',
		coverImage: 'Imagen de portada',
		coverPreviewAlt: 'Vista previa de la portada',
		coverCollageNote: 'Sin portada: se usará este collage con las imágenes de tus opciones.',
		...
		optionAddImage: 'Añadir imagen',
		optionAddImageLocked: 'Inicia sesión para añadir una imagen',
		options: 'Opciones',
		optionsMin: 'mín. {n}',
		optionsHelp:
			'Las cosas que la gente clasificará en duelos 1 contra 1. Las imágenes son opcionales — haz clic en el recuadro junto al nombre para subir una.',
		optionsLockedNote: 'Inicia sesión para añadir imágenes a tus opciones',
		...
		errCoverRequired: 'Añade una imagen de portada, o una imagen a al menos 4 opciones.',
		errMinOptions: 'Añade al menos {n} opciones con nombre.',
		errOptionNameNeeded: 'Cada opción con imagen necesita un nombre.',
		errUploadsPending: 'Espera a que terminen de subirse las imágenes.',
		errImageUpload: 'No se pudo subir la imagen. Inténtalo de nuevo.',
		errImageRejected: 'Esa imagen podría infringir nuestras normas de contenido. Prueba con otra.',
...
<section><h2 class="text-xl font-semibold text-text-primary mb-3 mt-6">2. Cómo utilizamos tu información</h2><p class="mb-3">Utilizamos tu información para:</p><ul class="list-disc pl-5 space-y-2"><li>Prestar, mantener y mejorar el Servicio.</li><li>Comunicarnos contigo.</li><li>Garantizar la seguridad y prevenir el fraude.</li><li>Analizar el uso y mejorar la experiencia del usuario.</li></ul><p class="mt-3"><strong class="text-text-primary">Correos comerciales.</strong> Solo te enviamos novedades sobre RANKMAKER —nuevas funciones, rankings destacados— si nos has dado tu consentimiento expreso, ya sea con la casilla que aparece al crear la cuenta o con el interruptor «Novedades» de tu página de preferencias. Está desactivado por defecto, es independiente de los correos de notificación que genera tu propia actividad y puedes retirar tu consentimiento en cualquier momento desde ese mismo interruptor, sin que afecte al resto del Servicio.</p></section>
...
<section><h2 class="text-xl font-semibold text-text-primary mb-3 mt-6">12. Contacto</h2><p>Para preguntas, contacta con: <a href="mailto:rankmaker.net@gmail.com" class="text-primary hover:underline">rankmaker.net@gmail.com</a>.</p></section>`,
	...
	preferences: {
		...
		emailHeading: 'Correo',
		emailPrefHeading: 'Notificaciones de actividad',
		...
		emailPrefLoginHint: 'Inicia sesión para elegir qué correos quieres recibir.',
		marketingHeading: 'Novedades',
		marketingDesc:
			'Envíame de vez en cuando un correo sobre nuevas funciones y los mejores rankings de RANKMAKER. Sin spam, y puedes desactivarlo cuando quieras.',
		marketingToggle: 'Activar correos de novedades',
		marketingPolicy: 'Cómo tratamos tus datos',
