...
export const es: LocaleDict = {
	tooltip: {
		...
		voteUp: 'Vota a favor: dile a los demás que merece la pena ordenarla',
		voteDown: 'Vota en contra: esta plantilla se puede mejorar',
		save: 'Guárdala en tu lista para encontrarla más tarde',
		unsave: 'Quita esta plantilla de tu lista de guardados',
		share: 'Comparte esta plantilla',
		...
		addOption: 'Añade otra opción para ordenar',
